...
public class Staggered_E_S_W extends Command {
	...
	public Staggered_E_S_W(WristPreset Wpreset, ShoulderPreset Spreset, ElevatorPreset Epreset) {
    ...
    protected void execute() {
		...
		if(HAL.elevator.isAtTarget()) {
            HAL.shoulder.setPosition(Spreset);
            HAL.wrist.setPosition(Wpreset);
        } else {
            HAL.wrist.setPosition(WristPreset.PLACE_TRAVEL);
            HAL.shoulder.setPosition(ShoulderPreset.PLACE_TRAVEL);
        }
	}
